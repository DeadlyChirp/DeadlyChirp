...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    justify_format(root, 'loc_del', loc_data[1], 12)
...
if __name__ == '__main__':
    """
    Long Tang (DeadlyChirp), 2026.
    Generator by Andrew Grant (github.com/Andrew6rant/Andrew6rant), 2022-2025.
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2001, 8, 6))
